...
import com.javaaidev.llmagentbuilder.core.observation.AgentToolExecutionObservationContext
import com.javaaidev.llmagentbuilder.core.observation.AgentToolExecutionObservationDocumentation
import com.javaaidev.llmagentbuilder.core.observation.DefaultAgentToolExecutionObservationConvention
    ...
    override fun get(): Map<String, FunctionCallback> {
        ...
        return agentToolsProvider.get().mapValues { (_, tool) ->
            ...
            InstrumentedFunctionCallbackWrapper(
                com.javaaidev.llmagentbuilder.core.tool.ToolFunctionCallback(tool, objectMapper),
                observationRegistry
            )
        }
    }
...
object AgentToolsProviderFactory {
    ...
    fun create(tools: List<com.javaaidev.llmagentbuilder.core.ToolConfig>): AgentToolsProvider {
